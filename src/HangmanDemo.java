...
public class HangmanDemo {
	...
	public static void main(String[] args) {
		...
		do {
			...
			currentLetter = ' '; //4 user enter letter try to guess the word.Looping if...
	...
	}while(!"N".contains(String.valueOf(playAgain).toUpperCase())); //11 if user press Y to continue game
